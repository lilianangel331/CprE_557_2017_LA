...
unsigned int createTriangleStripModel(void)
{
	...
	float* vertices = new float[122];
	float* colors = new float[122];

	int i = 0;
	//strip1
	vertices[i++] = 0;   vertices[i++] = 0;  vertices[i++] = 0;
	vertices[i++] = 0;   vertices[i++] = 0;  vertices[i++] = 1;
	vertices[i++] = -1;  vertices[i++] = 0;  vertices[i++] = 0;
	vertices[i++] = -1;  vertices[i++] = 0;  vertices[i++] = 1;
	vertices[i++] = -3;  vertices[i++] = 0;  vertices[i++] = 0;
	vertices[i++] = -3;  vertices[i++] = 0;  vertices[i++] = 1;
	vertices[i++] = -3;  vertices[i++] = 1;  vertices[i++] = 0;
	vertices[i++] = -3;  vertices[i++] = 1;  vertices[i++] = 1;
	vertices[i++] = -1;  vertices[i++] = 1;  vertices[i++] = 0;
	vertices[i++] = -1;  vertices[i++] = 1;  vertices[i++] = 1;
	vertices[i++] = -1;  vertices[i++] = 2;  vertices[i++] = 0;
	...
	//strip2							   	
	vertices[i++] = 0;   vertices[i++] = 0;  vertices[i++] = 1;
	vertices[i++] = 0;   vertices[i++] = 0;  vertices[i++] = 3;
	vertices[i++] = -1;  vertices[i++] = 0;  vertices[i++] = 1;
	vertices[i++] = -1;  vertices[i++] = 0;  vertices[i++] = 3;
	vertices[i++] = -1;  vertices[i++] = 2;  vertices[i++] = 1;
	vertices[i++] = -1;  vertices[i++] = 1;  vertices[i++] = 3;
	vertices[i++] = 0;   vertices[i++] = 2;  vertices[i++] = 1;
	vertices[i++] = 0;   vertices[i++] = 1;  vertices[i++] = 3;
	vertices[i++] = 0;   vertices[i++] = 0;  vertices[i++] = 1;
	vertices[i++] = 0;   vertices[i++] = 0;  vertices[i++] = 3;
	vertices[i++] = -1;  vertices[i++] = 0;  vertices[i++] = 3;
	vertices[i++] = 0;   vertices[i++] = 1;  vertices[i++] = 3;
	...
	glBufferData(GL_ARRAY_BUFFER, 123 * sizeof(GLfloat), vertices, GL_STATIC_DRAW);
	...
	glBufferData(GL_ARRAY_BUFFER, 123 * sizeof(GLfloat), colors, GL_STATIC_DRAW);
...
unsigned int createTriangleModel(void)
{
	...
	float* vertices = new float[341];
	float* colors = new float[341];
	...
	vertices[i++] = 0;   vertices[i++] = 1;  vertices[i++] = 1;
	...
	// vertices
	glBindBuffer(GL_ARRAY_BUFFER, vboID[0]);
	glBufferData(GL_ARRAY_BUFFER, 342 * sizeof(GLfloat), vertices, GL_STATIC_DRAW);
	...
	//Color
	glBindBuffer(GL_ARRAY_BUFFER, vboID[1]);
	glBufferData(GL_ARRAY_BUFFER, 342 * sizeof(GLfloat), colors, GL_STATIC_DRAW);
...
void renderTriangleStripModel(void)
{
	...
	// COMPLETE THE LINE
    // Draw the triangles
	glDrawArrays(GL_TRIANGLE_STRIP, 0 , 123);
...
void renderTriangleModel(void)
{
	...
	// COMPLETE THE LINE
    // Draw the triangles
	glDrawArrays(GL_TRIANGLES, 0, 342);
